# Generated by Django 2.0 on 2018-11-11 12:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bill_type', models.CharField(choices=[('SPOT', 'Spot'), ('DOWNPAYMENT', 'Downpayment'), ('INSTALLMENT', 'Installment'), ('OTHERS', 'Others')], default='SPOT', max_length=64)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='memorial_park_mgmnt_app.Agent')),
                ('bill', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='memorial_park_mgmnt_app.Bill')),
            ],
        ),
        migrations.CreateModel(
            name='Contract',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(default=datetime.date.today)),
                ('amount', models.FloatField(default=0.0)),
                ('payment_type', models.CharField(choices=[('CASH', 'Cash'), ('CHECK', 'Check'), ('OTHERS', 'Others')], default='CASH', max_length=32)),
                ('remarks', models.CharField(blank=True, max_length=256, null=True)),
                ('branch', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='receipts', to='memorial_park_mgmnt_app.Branch')),
            ],
        ),
        migrations.CreateModel(
            name='Service',
        ...
        migrations.AddField(
            model_name='payment',
            name='receipt',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='memorial_park_mgmnt_app.Receipt'),
        ),
        migrations.AddField(
            model_name='lot',
            name='lot_type',
        ...
        migrations.AddField(
            model_name='contract',
            name='lot',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='lot_contracts', to='memorial_park_mgmnt_app.Lot'),
        ),
        migrations.AddField(
            model_name='contract',
            name='referent',
